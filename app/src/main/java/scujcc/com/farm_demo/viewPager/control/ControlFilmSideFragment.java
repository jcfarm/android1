...
public class ControlFilmSideFragment extends Fragment {
    private String title;
    private TextView tv_title;
    private static final String TAG = ControlFilmSideFragment.class.getSimpleName();;
    View v=null;
    ...
    public static ControlFilmSideFragment newInstance(String title) {

        Bundle args = new Bundle();
        args.putString("title", title);
        ControlFilmSideFragment fragment = new ControlFilmSideFragment();
...
//        url="http://www.391k.com/api/xapi.ashx/info.json?key=bd_hyrzjjfb4modhj&size=10&page=1";
        ...
        OkHttpUtils
                ...
                .id(100)
                .build()
                .execute(new ControlFilmSideFragment.MyStringCallback());
    }
