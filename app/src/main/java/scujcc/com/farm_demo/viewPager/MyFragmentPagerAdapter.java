...
public class MyFragmentPagerAdapter extends PagerAdapter {
    ...
    public MyFragmentPagerAdapter(FragmentManager fm, Context context, ArrayList<BaseFragment> fragments) {

//        super(fm);
        titles = context.getResources().getStringArray(R.array.pager_labels);
    ...
    public MyFragmentPagerAdapter(FragmentManager supportFragmentManager, RootHomeFragment rootHomeFragment) {
